...
@implementation HHKeyBoardMoreFlowLayout
...
- (void)applyLayoutAttributes:(UICollectionViewLayoutAttributes *)attributes {
    ...
    [_sectionDic setValue:@(pageRe) forKey:[NSString stringWithFormat:@"%ld", (long)section]];
    ...
    if (self.scrollDirection == UICollectionViewScrollDirectionHorizontal) {
        ...
        //获取到的最后的数减去最后一组的页码数
        actualLo -= [_sectionDic[[NSString stringWithFormat:@"%u", [_sectionDic allKeys].count-1]] integerValue];
