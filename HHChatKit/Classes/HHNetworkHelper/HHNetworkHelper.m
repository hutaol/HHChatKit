...
+ (NSURLSessionTask *)uploadFileWithURL:(NSString *)URL parameters:(id)parameters name:(NSString *)name filePath:(NSString *)filePath progress:(HTHttpProgress)progress success:(HHResponseSuccess)success failure:(HHResponseFailure)failure {
...
+ (NSURLSessionTask *)downloadWithURL:(NSString *)URL fileDir:(NSString *)fileDir progress:(HTHttpProgress)progress success:(void (^)(NSString * _Nonnull))success failure:(HHResponseFailure)failure {
    ...
    __block NSURLSessionDownloadTask *downloadTask = [_sessionManager downloadTaskWithRequest:request progress:^(NSProgress * _Nonnull downloadProgress) {
        ...
        if (success) {
            success(filePath.absoluteString);  /** NSURL->NSString*/
